...
export default function Default (props) {
  return (
    <main className='flex flex-column relative ma3-l bg-white' aria-label='Content'>
      <div className='nav flex flex-row justify-between mb4 fixed top-0 left-0 w-100 bg-white'>
        ...
        <Link to={'/projects'} className='link black fr ma3'>Projects</Link>
      </div>
