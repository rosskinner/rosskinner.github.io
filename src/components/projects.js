    ...
    <div className='page projects-container f3 ph4-l flex items-center justify-center'>
      <div className='w-100 project-link-container'>
        {Array.from(projects).map((pro, key) => {
          ...
          return(
            <Link className='pointer link black pointer ma1 project-link f2 f1-l georgia db' to={`projects${project.permalink}`} key={key} alt={ project.title } title={ project.title } >
